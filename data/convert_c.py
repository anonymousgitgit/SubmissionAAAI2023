...
def convert_into_c_graph(tree, text):
    ...
    # print('stmt:', len(_stmts), len(stmts))
    ...
    # print(refactor_json)
    # ast_ids =  ast_nodes.keys()
    # print('stmt indices', G.number_of_nodes(), len(ast_ids), len(stmt_indices), len(set(ast_ids) & set(stmt_indices)))
