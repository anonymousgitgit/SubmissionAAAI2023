...
class MaskedCSNDataset(Dataset):
    def __init__(self, vocab_obj, lang_obj, data_path, parser, dgl_format, num_node_types, max_seq_length, tokenizer):
    ...
    def __getitem__(self, index):
        ...
        extra_src_info = {'src_vocab': src_vocab, 'extra_src_token_ids': extra_src_token_ids, 'src_token_ids_vocab': src_token_ids_vocab, 'text': text}
