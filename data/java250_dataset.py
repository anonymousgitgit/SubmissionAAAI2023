...
import dgl
import torch
from data.full_convert_java import convert_into_java_graph
from torch.utils.data import Dataset

class Java250Dataset(Dataset):
    def __init__(self, class_mapping, tokenizer, vocab_obj, paths, texts, parser, dgl_format, num_node_types):
    ...
    def __getitem__(self, index):
        ...
        label = self.class_mapping[path.split(os.path.sep)[-2]]
